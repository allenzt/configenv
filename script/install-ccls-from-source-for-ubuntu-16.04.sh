...
cmake -H. -BRelease -DCMAKE_BUILD_TYPE=Release -DCMAKE_PREFIX_PATH=/home/dengzt/clang+llvm-7.0.1-x86_64-linux-gnu-ubuntu-16.04 -DCMAKE_CXX_COMPILER=/usr/bin/g++-7
